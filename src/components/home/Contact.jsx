        ...
        <div className="contact__social">
          ...
          <div className="contact__social-data">
            ...
            <div className="contact__social-links">
              {/* WhatsApp */}
              <a href="https://wa.me/62895605210002" target="_blank" className="contact__social-link">
                <i className="ri-whatsapp-line"></i>
              </a>

              {/* Instagram */}
              <a href="https://www.instagram.com/octalectzz/" target="_blank" className="contact__social-link">
                <i className="ri-instagram-line"></i>
              </a>

              {/* Telegram */}
              <a href="https://t.me/octalectzz" target="_blank" className="contact__social-link">

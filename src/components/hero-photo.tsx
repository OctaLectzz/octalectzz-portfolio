...
export function HeroPhoto() {
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto flex w-full max-w-lg flex-col items-center lg:mr-0 lg:block"
    >
      {/* Photo and Orbits Wrapper */}
      <div className="relative aspect-square w-full">
        ...
        <motion.div
          ...
          className="absolute top-0 -left-4 z-20 lg:top-4 lg:-left-8"
        >
      ...
      {/* Terminal - Below photo on mobile, absolute on desktop */}
      <motion.div
        initial={{ opacity: 0, y: 40, x: 0, scale: 0.8 }}
        animate={{ opacity: 1, y: 0, x: 0, scale: 1 }}
        transition={{ delay: 1.1, type: 'spring', damping: 15 }}
        className="relative z-30 mt-12 w-full max-w-[280px] sm:max-w-[320px] lg:absolute lg:-bottom-6 lg:-left-24 lg:mt-0 lg:max-w-[240px]"
      >
